...
case "${PM}" in
  apt)
    CORE_PKGS=(cmake build-essential libboost-dev libsqlite3-dev libsdl2-dev libsdl2-image-dev libsdl2-ttf-dev libsdl2-gfx-dev libopenal-dev libgl1-mesa-dev)
