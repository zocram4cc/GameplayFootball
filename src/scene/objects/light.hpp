...
enum e_LightType { e_LightType_Directional, e_LightType_Point };
...
public:
  ...
  virtual void EnqueueShadowMap(boost::intrusive_ptr<Camera> camera,
...
public:
  ...
  virtual void EnqueueShadowMap(boost::intrusive_ptr<Camera> camera,
                                std::deque<boost::intrusive_ptr<Geometry>> visibleGeometry) = 0;
