...
public:
  ...
  virtual void SetTextureVertex(unsigned char texture_unit, unsigned char pos, const real x,
  ...
  // ----- intersections
  virtual void IntersectsPlane(bool intersects[], const Vector3& pvector,
