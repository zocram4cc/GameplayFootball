...
bool FootballAnimationExtension::GetKeyFrame(int frame, Quaternion& orientation, Vector3& position,
                                             float& power) const {
...
void FootballAnimationExtension::SetKeyFrame(int frame, const Quaternion& orientation,
                                             const Vector3& position, float power) {
