...
public:
  ...
  virtual bool GetKeyFrame(int frame, Quaternion& orientation, Vector3& position,
                           float& power) const = 0;
  virtual void SetKeyFrame(int frame, const Quaternion& orientation,
                           const Vector3& position = Vector3(0, 0, 0), float power = 1.0) = 0;
