...
public:
  ...
  void GetCoordinates(float x_percent, float y_percent, float width_percent, float height_percent,
  ...
  void SetPageFactory(Gui2PageFactory* factory) {
    pageFactory = factory;
    factory->SetWindowManager(this);
  }
