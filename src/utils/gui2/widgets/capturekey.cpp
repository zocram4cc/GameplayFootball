...
Gui2CaptureKey::Gui2CaptureKey(Gui2WindowManager* windowManager, const std::string& name)
    : Gui2View(windowManager, name, 0, 0, 0, 0) {
  isSelectable = true;
  keyID = -1;
}
...
Gui2CaptureJoy::Gui2CaptureJoy(Gui2WindowManager* windowManager, const std::string& name,
                               int controllerID)
    : Gui2View(windowManager, name, 0, 0, 0, 0), controllerID(controllerID) {
  isSelectable = true;
