...
Gui2Menu::Gui2Menu(Gui2WindowManager* windowManager, Gui2Menu* parentMenu, const std::string& name,
                   float x_percent, float y_percent, float width_percent, float height_percent)
    : Gui2Frame(windowManager, name, x_percent, y_percent, width_percent, height_percent),
