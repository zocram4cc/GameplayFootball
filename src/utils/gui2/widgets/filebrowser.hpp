...
enum e_DirEntryType { e_DirEntryType_File, e_DirEntryType_Directory, e_DirEntryType_None };
...
public:
  Gui2FileBrowser(Gui2WindowManager* windowManager, const std::string& name, float x_percent,
                  float y_percent, float width_percent, float height_percent,
                  const std::string& startDir, e_DirEntryType selectType = e_DirEntryType_File);
