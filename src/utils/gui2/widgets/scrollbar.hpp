...
enum e_Gui2ScrollbarMode { e_Gui2ScrollbarMode_Horizontal, e_Gui2ScrollbarMode_Vertical };

class Gui2Scrollbar : public Gui2View {
public:
  Gui2Scrollbar(Gui2WindowManager* windowManager, const std::string& name, float x_percent,
