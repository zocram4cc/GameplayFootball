...
void LoadingMatchPage::Process() {
  ...
  if (!sentStartGameSignal) {
    ...
    EnvironmentManager::GetInstance().Pause_ms(
        100);  // make 'sure' the logos have been displayed by the graphics thread. todonow: this is
               // a terrible hax, and you know it. you are a bad person!
