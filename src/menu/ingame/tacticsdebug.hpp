...
public:
  Gui2TacticsDebug(Gui2WindowManager* windowManager, const std::string& name, float x_percent,
  ...
  virtual unsigned int AddEntry(const std::string& caption, const Vector3& color1,
