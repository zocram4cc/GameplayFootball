...
GameplayPage::GameplayPage(Gui2WindowManager* windowManager, const Gui2PageData& pageData)
  ...
  slider_ShortPass_AutoDirection->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_ShortPass_AutoPower = new Gui2Slider(windowManager, "slider_shortpass_autopower", 0, 0, 30,
                                              6, "short pass - power assist");
  slider_ShortPass_AutoPower->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_ThroughPass_AutoDirection =
      new Gui2Slider(windowManager, "slider_throughpass_autodirection", 0, 0, 30, 6,
                     "through pass - direction assist");
  slider_ThroughPass_AutoDirection->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_ThroughPass_AutoPower = new Gui2Slider(windowManager, "slider_throughpass_autopower", 0, 0,
                                                30, 6, "through pass - power assist");
  slider_ThroughPass_AutoPower->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_HighPass_AutoDirection = new Gui2Slider(windowManager, "slider_highpass_autodirection", 0,
                                                 0, 30, 6, "high pass - direction assist");
  slider_HighPass_AutoDirection->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_HighPass_AutoPower = new Gui2Slider(windowManager, "slider_highpass_autopower", 0, 0, 30,
                                             6, "high pass - power assist");
  slider_HighPass_AutoPower->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_Shot_AutoDirection = new Gui2Slider(windowManager, "slider_shot_autodirection", 0, 0, 30,
                                             6, "shot - direction assist");
  slider_Shot_AutoDirection->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_Agility =
      new Gui2Slider(windowManager, "slider_agility", 0, 0, 30, 6, "human agility factor");
  ...
  slider_Acceleration = new Gui2Slider(windowManager, "slider_acceleration", 0, 0, 30, 6,
                                       "human acceleration factor");
  slider_Acceleration->AddHelperValue(Vector3(80, 80, 250), "factory setting",
  ...
  slider_Quantization = new Gui2Slider(windowManager, "slider_quantization", 0, 0, 30, 6,
                                       "8-way-quantization (more D-pad'y)");
  slider_Quantization->AddHelperValue(Vector3(80, 80, 250), "factory setting",
