...
LeagueSystemPage::LeagueSystemPage(Gui2WindowManager* windowManager, const Gui2PageData& pageData)
  ...
  Gui2Caption* title =
      new Gui2Caption(windowManager, "caption_league_system", 20, 20, 60, 3, "System");
  this->AddView(title);
  title->Show();
...
LeagueSystemSavePage::LeagueSystemSavePage(Gui2WindowManager* windowManager,
    ...
    : Gui2Page(windowManager, pageData) {
  Gui2Caption* title =
      new Gui2Caption(windowManager, "caption_league_system_save", 20, 20, 60, 3, "Save");
  this->AddView(title);
  title->Show();
...
LeagueSystemSettingsPage::LeagueSystemSettingsPage(Gui2WindowManager* windowManager,
    ...
    : Gui2Page(windowManager, pageData) {
  Gui2Caption* title =
      new Gui2Caption(windowManager, "caption_league_system_settings", 20, 20, 60, 3, "Settings");
  this->AddView(title);
  title->Show();
