...
LeagueManagementPage::LeagueManagementPage(Gui2WindowManager* windowManager,
  ...
  Gui2Caption* title =
      new Gui2Caption(windowManager, "caption_league_management", 20, 20, 60, 3, "Management");
  this->AddView(title);
  title->Show();
...
LeagueManagementContractsPage::LeagueManagementContractsPage(Gui2WindowManager* windowManager,
                                                             const Gui2PageData& pageData)
    : Gui2Page(windowManager, pageData) {
  Gui2Caption* title = new Gui2Caption(windowManager, "caption_league_management_contracts", 20, 20,
                                       60, 3, "Contracts");
  this->AddView(title);
...
LeagueManagementTransfersPage::LeagueManagementTransfersPage(Gui2WindowManager* windowManager,
                                                             const Gui2PageData& pageData)
    : Gui2Page(windowManager, pageData) {
  Gui2Caption* title = new Gui2Caption(windowManager, "caption_league_management_transfers", 20, 20,
                                       60, 3, "Transfers");
  this->AddView(title);
