...
void Initialize(Properties& config) {
  ...
  std::shared_ptr<ResourceManager<GeometryData>> geometryDataResourceManager(
      new ResourceManager<GeometryData>("geometrydata"));
  std::shared_ptr<ResourceManager<Surface>> surfaceResourceManager(
      new ResourceManager<Surface>("surface"));
  std::shared_ptr<ResourceManager<SoundBuffer>> soundBufferResourceManager(
      new ResourceManager<SoundBuffer>("soundbuffer"));

  ResourceManagerPool::GetInstance().RegisterManager(e_ResourceType_GeometryData,
                                                     geometryDataResourceManager);
  ResourceManagerPool::GetInstance().RegisterManager(e_ResourceType_Surface,
                                                     surfaceResourceManager);
  ResourceManagerPool::GetInstance().RegisterManager(e_ResourceType_SoundBuffer,
                                                     soundBufferResourceManager);
