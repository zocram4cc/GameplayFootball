...
template <>
TaskManager* Singleton<TaskManager>::singleton = 0;
...
void TaskManager::Initialize() {
  ...
  if (numthreads < 3)
    numthreads = 3;  // todo: make minimum configurable
...
void TaskManager::GetFullWorkerThreadState(int workerThreadIndex, e_ThreadState& state,
