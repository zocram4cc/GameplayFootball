...
// this class is not reentrant, derived classes and their users take this responsibility (by using
// Subject::subjectMutex)
...
public:
  ...
  std::vector<boost::intrusive_ptr<T>> GetObservers() { return observers; }
