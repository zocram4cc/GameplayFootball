...
enum e_ViewRenderTarget { e_ViewRenderTarget_Texture, e_ViewRenderTarget_Context };
...
enum e_RenderMode { e_RenderMode_GeometryOnly, e_RenderMode_Diffuse, e_RenderMode_Full };
