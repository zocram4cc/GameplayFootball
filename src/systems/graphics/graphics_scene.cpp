...
GraphicsScene_Scene3DInterpreter::GraphicsScene_Scene3DInterpreter(GraphicsScene* caller)
    : caller(caller) {}
...
GraphicsScene_Scene2DInterpreter::GraphicsScene_Scene2DInterpreter(GraphicsScene* caller)
    : caller(caller) {}
