...
public:
  ...
  virtual void ActorApplyForceAtRelativePosition(IPhysicsActor* actor, float force,
                                                 const Vector3& direction, const Vector3& position);
  ...
  virtual void JointSetVelocity(IPhysicsJoint* joint, float velocity,
                                int paramNum = 1);  // desired velocity
  virtual void JointSetMaxForce(IPhysicsJoint* joint, float force,
                                int paramNum = 1);  // maximum force to reach the desired velocity
