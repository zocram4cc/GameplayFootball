...
def prepare_match_anim(path, anim_class):
    ...
    # An action clip holds the player until it runs out; PES follow-throughs
    # run on far longer than GF's, so keep enough to read as a follow-through
    # and give the engine back its player.
